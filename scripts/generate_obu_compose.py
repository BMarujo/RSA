...
def common_obu_env(vehicle: Vehicle, index: int) -> list[tuple[str, str]]:
    ...
    values = {
        ...
        "MERGE_PRIORITY": env("MERGE_PRIORITY", "true"),
        "DEFAULT_SPEED_MODE": env("DEFAULT_SPEED_MODE", "31"),
        "PRIORITY_SPEED_MODE": env("PRIORITY_SPEED_MODE", "31"),
        "PRIORITY_DISTANCE": env("PRIORITY_DISTANCE", "120.0"),
        ...
        "MIN_SPEED": env("MIN_SPEED", "0.5"),
        "MAX_SPEED_STEP_UP": env("MAX_SPEED_STEP_UP", "2.5"),
        "MAX_SPEED_STEP_DOWN": env("MAX_SPEED_STEP_DOWN", "2.0"),
        "MERGE_YIELD_FLOOR_RATIO": env("MERGE_YIELD_FLOOR_RATIO", "0.55"),
        "HOST_YIELD_FLOOR_RATIO": env("HOST_YIELD_FLOOR_RATIO", "0.55"),
        ...
        "MERGE_COMMIT_DISTANCE": env("MERGE_COMMIT_DISTANCE", "45.0"),
        "MERGE_COMMIT_MIN_SPEED": env("MERGE_COMMIT_MIN_SPEED", "8.0"),
        "MERGE_COMMIT_CLEARANCE_RATIO": env("MERGE_COMMIT_CLEARANCE_RATIO", "0.75"),
