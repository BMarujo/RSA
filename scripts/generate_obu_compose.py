...
def common_obu_env(vehicle: Vehicle, index: int, ramp_station_ids: str, main_station_ids: str) -> list[tuple[str, str]]:
    ...
    values = {
        ...
        "MIRROR_VANETZA_TOPICS": env("MIRROR_VANETZA_TOPICS", "true"),
        ...
        "MERGE_ZONE_CLEARANCE_M": env("MERGE_ZONE_CLEARANCE_M", "45.0"),
        "MERGE_STOP_MARGIN_M": env("MERGE_STOP_MARGIN_M", "18.0"),
        "MERGE_BLOCKED_APPROACH_S": env("MERGE_BLOCKED_APPROACH_S", "4.0"),
        ...
        "PRIORITY_DISTANCE": env("PRIORITY_DISTANCE", env("PRIORITY_DISTANCE_M", "60.0")),
        ...
        "NEGOTIATION_TIMEOUT_S": env("NEGOTIATION_TIMEOUT_S", "3.5"),
        "HOST_RESERVATION_S": env("HOST_RESERVATION_S", "4.0"),
        ...
        "MERGE_NEIGHBOR_WARMUP_S": env("MERGE_NEIGHBOR_WARMUP_S", "1.0"),
        "MERGE_MIN_NEIGHBORS_BEFORE_MERGE": env("MERGE_MIN_NEIGHBORS_BEFORE_MERGE", "0"),
        ...
        "MERGE_COMMIT_DISTANCE_M": env("MERGE_COMMIT_DISTANCE_M", "55.0"),
        "MERGE_CONFLICT_FOLLOW_DISTANCE_M": env("MERGE_CONFLICT_FOLLOW_DISTANCE_M", "55.0"),
        "MERGE_CONFLICT_FLOOR_RATIO": env("MERGE_CONFLICT_FLOOR_RATIO", "0.55"),
        ...
        "EMERGENCY_MIN_SPEED": env("EMERGENCY_MIN_SPEED", "0.0"),
        ...
        "MERGE_QUEUE_RELEASE_GAP": env("MERGE_QUEUE_RELEASE_GAP", "34.0"),
        "ENABLE_CAM_FOLLOWING": env("ENABLE_CAM_FOLLOWING", "true"),
        ...
        "CAM_FOLLOW_LATERAL_TOLERANCE_M": env("CAM_FOLLOW_LATERAL_TOLERANCE_M", "3.8"),
        "CAM_FOLLOW_SPEED_DELTA": env("CAM_FOLLOW_SPEED_DELTA", "0.8"),
        "CAM_FOLLOW_CRITICAL_GAP_M": env("CAM_FOLLOW_CRITICAL_GAP_M", "6.0"),
        ...
        "HOST_COOPERATIVE_LANE_CHANGE": env("HOST_COOPERATIVE_LANE_CHANGE", "false"),
        "HOST_CLEAR_LANE_HOLD_S": env("HOST_CLEAR_LANE_HOLD_S", "12.0"),
        "HOST_RETURN_LOCK_DISTANCE_M": env("HOST_RETURN_LOCK_DISTANCE_M", "90.0"),
...
def write_compose(output: Path, sumo_cfg: Path, vehicles: list[Vehicle], routes: dict[str, tuple[str, ...]]) -> None:
    ...
    lines = [
        ...
        f"      - TRACI_DEFAULT_SPEED_MODE={env('TRACI_DEFAULT_SPEED_MODE', '0')}",
        f"      - TRACI_DEFAULT_LANE_CHANGE_MODE={env('TRACI_DEFAULT_LANE_CHANGE_MODE', '0')}",
        f"      - TRACI_VEHICLE_DECEL={env('TRACI_VEHICLE_DECEL', '50.0')}",
        f"      - TRACI_VEHICLE_EMERGENCY_DECEL={env('TRACI_VEHICLE_EMERGENCY_DECEL', '50.0')}",
