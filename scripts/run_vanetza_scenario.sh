...
case "$VANETZA_SCENARIO" in
    dense)
        ...
        default_env HOST_YIELD_FLOOR_RATIO "0.6"
        default_env MERGE_YIELD_FLOOR_RATIO "0.5"

        default_env SAFE_HEADWAY_S "1.0"
        default_env MIN_CLEARANCE_M "5.0"
        default_env HOST_REJECT_DISTANCE_M "20.0"
        default_env MERGE_ZONE_CLEARANCE_M "5.0"
        default_env MERGE_STOP_MARGIN_M "5.0"
        default_env MERGE_BLOCKED_APPROACH_S "3.0"

        default_env RAMP_PLATOON_HEADWAY_S "1.0"
        default_env RAMP_PLATOON_MIN_GAP "10.0"
        default_env RAMP_PLATOON_SPEED_DELTA "1.0"
        default_env MERGE_QUEUE_RELEASE_GAP "15.0"

        default_env ENABLE_CAM_FOLLOWING "true"
        default_env CAM_FOLLOW_HEADWAY_S "1.0"
        default_env CAM_FOLLOW_MIN_GAP "5.0"
        ...
        default_env CAM_FOLLOW_CRITICAL_GAP_M "10.0"
