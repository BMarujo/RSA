...
case "$VANETZA_SCENARIO" in
    single-lane)
        ...
        default_env COLLISION_GUARD_LOOKAHEAD "45.0"
        default_env COLLISION_GUARD_MIN_GAP "7.5"
        default_env COLLISION_GUARD_HEADWAY_S "0.8"
        default_env COLLISION_GUARD_MIN_SPEED "1.8"
        default_env COLLISION_GUARD_DURATION_S "0.8"
        default_env HOST_YIELD_FLOOR_RATIO "0.68"
        default_env MERGE_YIELD_FLOOR_RATIO "0.68"
        default_env MIN_SPEED "2.0"
